  ...
  React.useLayoutEffect(() => {
    ...
    try {
      ...
      if (s && Number.isFinite(s.x) && Number.isFinite(s.y) && Number.isFinite(s.scale)) {
        ...
        apply();
        // Safety net: if the restored viewport parks the user outside the
        // content (e.g. the file kept its name but lost sections), the world
        // bounding box won't intersect the visible viewport. Reset on next
        // frame, after children have laid out.
        requestAnimationFrame(() => {
          ...
          const intersects =
            wRect.right  > vRect.left  &&
            wRect.left   < vRect.right &&
            wRect.bottom > vRect.top   &&
            wRect.top    < vRect.bottom;
          if (!intersects && wRect.width > 0 && wRect.height > 0) {
