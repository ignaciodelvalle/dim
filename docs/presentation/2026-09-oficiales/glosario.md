...
| Identificador (código) | Etiqueta en la lámina | Nota | Origen |
|---|---|---|---|
| `pnpm verify` | Cadena de verificación | <!-- fact:verify_fences -->71<!-- /fact --> guardas automatizadas. **Nunca "compuerta de calidad" ni "reglas automáticas"**: eran tres nombres para la misma cosa | acuñada |
...
| canon de convenciones | Regla del canon | <!-- fact:canon_enforced -->181<!-- /fact --> de <!-- fact:canon_rows -->519<!-- /fact --> reglas tienen quién las haga cumplir. El resto no está roto: nadie se daría cuenta | acuñada |
