...
| `lib/supabase/admin.ts` | Llave de servicio (salta el cerrojo) | <!-- fact:service_role_call_sites -->40<!-- /fact --> lugares la usan **por diseño**. Va en la misma lámina que el cerrojo | acuñada |
...
| Identificador (código) | Etiqueta en la lámina | Nota | Origen |
|---|---|---|---|
| `pnpm verify` | Cadena de verificación | <!-- fact:verify_fences -->70<!-- /fact --> guardas automatizadas. **Nunca "compuerta de calidad" ni "reglas automáticas"**: eran tres nombres para la misma cosa | acuñada |
...
| canon de convenciones | Regla del canon | <!-- fact:canon_enforced -->180<!-- /fact --> de <!-- fact:canon_rows -->518<!-- /fact --> reglas tienen quién las haga cumplir. El resto no está roto: nadie se daría cuenta | acuñada |
