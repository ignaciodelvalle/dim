...
| `lib/supabase/admin.ts` | Llave de servicio (salta el cerrojo) | <!-- fact:service_role_call_sites -->36<!-- /fact --> lugares la usan **por diseño**. Va en la misma lámina que el cerrojo | acuñada |
