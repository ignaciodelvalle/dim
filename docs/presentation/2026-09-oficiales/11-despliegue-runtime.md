...
- La cadena de verificación local es `pnpm verify` —<!-- fact:verify_fences -->68<!-- /fact -->
  controles automáticos— más la suite de <!-- fact:vitest_files -->1511<!-- /fact -->
...
- <!-- fact:migrations -->214<!-- /fact --> migraciones, solo hacia adelante y
  nunca editadas.
