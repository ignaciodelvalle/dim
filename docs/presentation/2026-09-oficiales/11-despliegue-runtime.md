...
- La cadena de verificación local es `pnpm verify` —<!-- fact:verify_fences -->70<!-- /fact -->
  controles automáticos— más la suite de <!-- fact:vitest_files -->1562<!-- /fact -->
...
- <!-- fact:migrations -->226<!-- /fact --> migraciones, solo hacia adelante y
  nunca editadas.
