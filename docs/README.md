...
Historical project artifacts from the 2021 university iteration of DIM. Kept in the repo for context and provenance — they document the original vision and inform the current rebuild — but they are **not specifications for the current codebase**. The authoritative current spec is [`AGENTS.md`](../AGENTS.md) at the repo root.
