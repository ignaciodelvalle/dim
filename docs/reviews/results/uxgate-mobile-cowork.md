...
| 5 | Consultas públicas de código (`DIM-DEMO-0001`, `DIM-DEMO-0002`, `DIM-HACH-0016`) | Lecturas; dispararon rate-limit (auto-reset). Sin efecto persistente. |
