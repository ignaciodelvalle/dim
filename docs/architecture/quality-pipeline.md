...
- <!-- fact:vitest_files -->1568<!-- /fact --> files Vitest discovers
...
<!-- fact:canon_rows -->519<!-- /fact --> rows, harvested from the project's
...
- <!-- fact:canon_enforced -->181<!-- /fact --> **ENFORCED** — a fence or test
