...
| ❎ diferido | Wizard adopción 28-preguntas (`docs/superpowers/plans/2026-05-20-adoption-handshake-unified.md` queda en backlog hasta nueva demanda) · **Chunk F** (Welfare MPF + PPP exports — plan listo, owner diferido) · **Chunk N** (Iconic-dataset cleanup — audit dice 0 phases tocan UI, ship como `chore:` cuando se quiera demo viva) |
