...
| R9 | **UNA PALABRA DEL PO — el mismo acto tiene tres verbos vivos**: el header dice "+ Registrar mascota", el vacío dice "Cargar una mascota", el slot nuevo dice "Cargar mascota" | `mis-mascotas/page.tsx:216` tiene un comentario que afirma que "Registrar" es EL verbo del acto, **citando D.8** — y la decisión fresca del PO, también D.8, eligió "Cargar mascota" para el slot | Se siguió la decisión explícita del PO y se dejó el comentario viejo sin tocar, en vez de pisar una de las dos en silencio. Se resuelve con una palabra |
| R10 | **Copy nuevo del vacío de /mis-mascotas** — "Al registrarla obtiene su credencial digital: una página pública con código QR que cualquiera puede verificar desde el celular. Es lo que ve quien la encuentre si alguna vez se pierde." | `33d341d5` | Deliberadamente NO promete la chapita física: ese canal está gateado por jurisdicción y prometerlo sería mentirle a un dueño de un municipio sin el canal habilitado |
