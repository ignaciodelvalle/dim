...
| **P4.2** | **SC-7 — el gemelo sin fence.** `font-[var(--font-ln-*)]`, 521 usos / 144 archivos, font-family MUERTA. 349 elementos que el diseño quiere monoespaciados se ven en la sans heredada. Unidad propia con guard y baseline nuevos (el fence actual matchea solo `text-`) | abierta |
