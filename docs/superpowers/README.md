...
|----------|---------|-----------|---------|
| 1 | **Welfare reports polish** | `plans/2026-05-18-welfare-reports-polish.md` | 4 fases pequeñas: bridge bug (`pet_events` no copia lat/lng), mapa missing en denuncia detail, rate-limit anónimo, cleanup docs. ~1 día. |
