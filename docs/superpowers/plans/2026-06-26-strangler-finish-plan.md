...
- [ ] `alert-firings.ts` — 430 lines
- [ ] `admin-decisions.ts` — 401 lines
- [ ] `pregnancy.ts` — 383 lines
- [ ] `profile.ts` — 354 lines
- [ ] `admin-proposals.ts` — 353 lines
- [ ] `chip-match.ts` — 339 lines
- [ ] `admin-org-verification.ts` — 328 lines
- [ ] `booking.ts` — 301 lines
- [ ] `schedule-rules.ts` — 289 lines
- [ ] `pet-tab-data.ts` — 278 lines
- [ ] `auth.ts` — 266 lines
- [ ] `amendment.ts` — 265 lines
- [ ] `slot-materialization.ts` — 263 lines
- [ ] `pet-sighting.ts` — 254 lines
- [ ] `claim.ts` — 251 lines
- [ ] `alert-subscriptions.ts` — 228 lines
