...
const CASE_DETAIL_SELECT = {
  ...
  primaryLocationLat: sql<string | null>`coalesce(${cases.locationLat}, ${cases.primaryLocationLat})`,
  primaryLocationLng: sql<string | null>`coalesce(${cases.locationLng}, ${cases.primaryLocationLng})`,
