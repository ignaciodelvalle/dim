// mark-achievement-seen.ts — use-case: records the first time an owner sees an earned
// achievement badge on their pet's profile (strangler migration 51/61).
//
// Drives the 7-day badge-pulse UX.
//
