...
export default async function AdminAuditoriaPage({
  ...
  // Build actor options for the dropdown: resolve distinct actors from the
  // current page + any selected actor not on this page.
  // We only show actors present in the current result set to keep the list
  // meaningful (it changes as filters narrow).
  ...
  // If actorFilter is set but no longer in the current page (e.g. pagination
  // moved past all their entries), add them from a fresh lookup so the
  // dropdown still shows the selected name.
