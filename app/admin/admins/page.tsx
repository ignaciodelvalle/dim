      ...
      <div className="max-w-5xl mx-auto space-y-6">
        <header className="flex items-start justify-between gap-4">
          <div className="space-y-1">
            <h1 className="text-3xl font-semibold tracking-tight text-gob-text">Administradores</h1>
    ...
    <li className="rounded-lg border border-gob-border px-4 py-3 flex items-center justify-between gap-4">
      <div className="min-w-0 space-y-0.5 flex items-center gap-2">
        <div>
          ...
          {admin.isSelf && (
            <span className="ml-2 text-[10px] uppercase tracking-wider px-1.5 py-0.5 bg-gob-warning/20 text-gob-warning-text rounded">
              Vos
            </span>
          )}
      ...
      <span
        className={`px-2 py-0.5 rounded uppercase tracking-wider text-[10px] shrink-0 ${
          isActive ? "bg-gob-success/10 text-gob-success" : "bg-gob-surface-alt text-gob-text-gray"
        }`}
      >
