...
const ROLE_TONES: Record<string, string> = {
  ...
  admin: "bg-gob-warning text-gob-warning-text",
};
      ...
      <div className="max-w-5xl mx-auto space-y-6">
        <header className="space-y-2">
          ...
          <p className="text-sm text-gob-text-gray">
            Buscá por nombre o DNI y proponé cambios de rol. Vista universal — todas las
            jurisdicciones. Las búsquedas quedan en el audit log.
          </p>
        </header>
        ...
        <form action="/admin/usuarios" method="get" className="flex items-center gap-2">
          <input
            ...
            className="flex-1 text-sm rounded-md border border-gob-border-strong bg-white px-3 py-1.5 focus:outline-none focus:ring-2 focus:ring-neutral-900"
          />
          <button
            type="submit"
