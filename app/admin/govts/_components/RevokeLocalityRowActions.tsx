...
export function RevokeLocalityRowActions({
  ...
  return (
    <button
      ...
      className="text-[10px] px-2 py-1 rounded border border-amber-300 text-gob-warning-text hover:opacity-90 transition-opacity"
    >
      Revocar
    </button>
  );
...
function RevokeLocalityForm({
  ...
  return (
    <div className="rounded border border-amber-200 p-3 space-y-3 bg-gob-warning/10 mt-2">
      ...
      <div className="flex items-center gap-2">
        <button
          ...
          onClick={submit}
          disabled={!canSubmit}
          className="text-xs px-3 py-1.5 rounded-md bg-amber-700 text-white hover:opacity-90 disabled:opacity-50"
        >
