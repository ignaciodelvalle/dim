...
//
// /admin/govts/new — render smoke test (opfilterbar-sweep2-2026-07-21, item
...
import NewGovtPage from "./page";

describe("/admin/govts/new — render smoke test", () => {
  it("uses the canonical space-y-6 shell, not a centered <main>/mx-auto wrapper", async () => {
    const node = await NewGovtPage();
    const html = renderToStaticMarkup(node);
    expect(html).toContain("Crear cuenta gobierno");
