  ...
  return (
    <main className="px-6 py-8">
      <div className="max-w-3xl mx-auto space-y-6">
        <Link href="/admin/outbox" className="text-sm text-neutral-500 hover:text-gob-text">
          ← Volver al outbox
        </Link>
        ...
        {canRetry && (
          <section className="rounded-lg border border-amber-200 bg-amber-50 p-4 space-y-3">
            <h2 className="text-sm font-semibold text-amber-900">Reintentar manualmente</h2>
            ...
            >
              <button
                type="submit"
                className="text-sm px-4 py-2 rounded-md bg-amber-700 text-white hover:opacity-90 font-medium"
              >
                Reintentar ahora
              </button>
            </form>
