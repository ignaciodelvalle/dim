...
export function MagicLinkResultPanel({
  ...
  return (
    <div className="rounded-lg border border-green-200 bg-green-50 p-6 space-y-4">
      <div>
        <h3 className="text-lg font-semibold text-green-900">Cuenta institucional creada</h3>
        ...
        <div className="flex gap-2">
          ...
          {magicLink && (
            <button
              type="button"
              onClick={handleCopy}
              className="px-3 py-2 text-sm bg-gob-primary text-white rounded hover:opacity-90 transition-colors shrink-0"
            >
      ...
      <div className="flex gap-3 pt-2">
        <a
          href={detailPath}
          className="px-4 py-2 text-sm bg-gob-primary text-white rounded hover:opacity-90 transition-colors"
        >
          Ver cuenta
        </a>
        {onCreateAnother && (
