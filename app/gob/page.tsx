    ...
    <GobDashboardShell
      ...
      actions={
        <>
          ...
          <Link
            href="/gob/maltrato"
            className="rounded-md border border-red-700 px-3 py-1.5 text-sm font-medium text-red-700 hover:bg-red-50"
          >
            Acta de infracción
          </Link>
        </>
      ...
      main={
        <>
          <DashboardCard
            ...
            action={
              <Link href="/gob/cola" className="text-gob-info hover:underline">
                Ver cola →
              </Link>
            }
          >
          ...
          <DashboardCard
            ...
            action={
              <Link href="/gob/casos" className="text-gob-info hover:underline">
      ...
      aside={
        <>
          <DashboardCard
            title="Vigilancia"
            action={
              <Link href="/gob/vigilancia" className="text-gob-info hover:underline">
                Ver →
              </Link>
            }
          >
          ...
          <DashboardCard
            ...
            action={
              <Link href="/gob/maltrato" className="text-gob-info hover:underline">
                Ver bandeja →
              </Link>
            }
          >
          ...
          <DashboardCard
            title="Pérdidas"
            action={
              <Link href="/gob/perdidas" className="text-gob-info hover:underline">
                Ver →
              </Link>
            }
          >
