  ...
  if (isLastAdmin) {
    return (
      <button
        ...
        className="cursor-not-allowed rounded-[var(--radius-pill)] border border-[var(--color-ln-line-strong)] px-2.5 py-[5px] font-[var(--font-ln-sans)] text-[11.5px] font-medium text-[var(--color-ln-mute)] opacity-50"
      >
        Renunciar
      </button>
    );
