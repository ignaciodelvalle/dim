...
export function NewPetForm() {
  ...
  return (
    <form action={formAction} className="space-y-4">
      ...
      <Section title="Identificación y raza">
        <div className="space-y-1.5">
          ...
          {breedIsDangerous && (
            <div className="mt-2 p-3 rounded-lg border border-amber-300 dark:border-amber-700 bg-amber-50 dark:bg-amber-950/30 text-xs text-amber-900 dark:text-amber-200">
              ...
              correspondiente. DIM marcará tu mascota con la flag oficial.
            </div>
          )}
        </div>
      ...
      <Section title="Salud y vida diaria">
        ...
        <SelectField id="trainingLevel" name="trainingLevel" label="Nivel de entrenamiento">
      ...
      {/* SECTION: Ubicación */}
      <Section title="Ubicación (ayuda a las campañas de salud animal)">
...
function SelectField({
  ...
  // If value is controlled, render controlled; otherwise uncontrolled w/ defaultValue.
