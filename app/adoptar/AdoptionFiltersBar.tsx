  ...
  return (
    ...
    >
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-3">
        ...
        <div>
          <label htmlFor="edad" className="block text-xs text-neutral-500 mb-1">
            Edad
          </label>
          <select
            id="edad"
        ...
        <div>
          <label htmlFor="talle" className="block text-xs text-neutral-500 mb-1">
            Talle
          </label>
          <select
            id="talle"
        ...
        <div>
          <label htmlFor="energia" className="block text-xs text-neutral-500 mb-1">
            Energía
          </label>
          <select
            id="energia"
      ...
      <div className="flex justify-end gap-2 pt-1">
        ...
        <button
          type="submit"
          className="px-4 py-1.5 rounded bg-neutral-900 dark:bg-neutral-50 text-white dark:text-neutral-900 text-xs font-medium"
        >
          Aplicar filtros
        </button>
      </div>
