...
// Client component for the vet-provider new service offering form (Fase 2.5).
// Mirrors app/org/[orgToken]/servicios/nuevo/ServiceOfferingForm.tsx but
// includes province/locality fields so the vet can declare their jurisdiction.
...
export function VetServiceOfferingForm({
  serviceKinds,
  createAction,
}: {
    ...
    <form action={formAction} className="space-y-5">
      ...
      <div className="space-y-1">
        ...
        <input
          ...
          minLength={3}
          maxLength={120}
          placeholder="Ej: Vacunación antirrábica — domicilio CABA"
          className="w-full rounded border border-neutral-300 dark:border-neutral-700 bg-white dark:bg-neutral-900 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-neutral-500"
        />
      </div>
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="space-y-1">
          <label htmlFor="jurisdictionProvince" className="block text-sm font-medium">
            Provincia <span className="text-neutral-400 font-normal">(opcional)</span>
          </label>
          <input
        ...
        <div className="space-y-1">
          <label htmlFor="jurisdictionLocality" className="block text-sm font-medium">
            Localidad <span className="text-neutral-400 font-normal">(opcional)</span>
          </label>
          <input
