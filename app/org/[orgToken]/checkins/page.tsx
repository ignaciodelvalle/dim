      ...
      <div className="max-w-3xl mx-auto space-y-8">
        ...
        <section className="space-y-3">
          <h2 className="text-lg font-semibold">
            Vencidos <span className="text-sm text-neutral-500">({overdue.length})</span>
          </h2>
          {overdue.length === 0 ? (
            <p className="text-sm text-neutral-500">
        ...
        <section className="space-y-3">
          <h2 className="text-lg font-semibold">
            Próximos <span className="text-sm text-neutral-500">({upcoming.length})</span>
          </h2>
          {upcoming.length === 0 ? (
        ...
        <section className="space-y-3">
          <h2 className="text-lg font-semibold">
            Check-ins recibidos{" "}
            <span className="text-sm text-neutral-500">({recentCheckins.length})</span>
          </h2>
