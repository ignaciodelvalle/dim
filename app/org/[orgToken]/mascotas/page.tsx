...
const ROLE_BADGE: Record<string, { label: string; className: string }> = {
  ...
  shelter_custody: {
    label: "En custodia",
    className: "bg-gob-warning/20 text-gob-warning-text",
  },
  foster: {
    label: "Tránsito",
  ...
  return (
    <main className="min-h-screen p-6 bg-white">
      <div className="max-w-3xl mx-auto space-y-6">
        ...
        {recentlyCreated && (
          <p className="text-sm rounded border border-gob-success/30 bg-gob-success/10 px-3 py-2 text-gob-text">
            Ingreso registrado. Token público: <code>{recentlyCreated}</code>.
          </p>
        )}
        {recentlyFostered && (
          <p className="text-sm rounded border border-gob-info/30 bg-gob-info/10 px-3 py-2 text-gob-info">
