...
function StatusBadge({ status }: { status: AlertFiringStatus }) {
  return (
    <span
      className={[
        "inline-flex items-center gap-[4px] rounded-[3px] border px-[7px] py-[2px]",
              ...
              >
                <td className="py-2.5 pr-4">
                  ...
                  {row.investigationCode ? (
                    <span className="ml-2 font-mono text-[10px] text-ln-op-viol">
                      {row.investigationCode}
                    </span>
                  ) : null}
                </td>
                ...
                <td className="py-2.5 pr-4 text-right tabular-nums">
                  ...
                  {isBreach ? (
                    <span
                      className="ml-2 inline-flex items-center gap-[3px] rounded-[3px] border border-ln-op-danger-bd bg-ln-op-danger-bg px-[6px] py-[1px] font-ln-mono text-[9px] font-bold uppercase text-ln-op-danger"
