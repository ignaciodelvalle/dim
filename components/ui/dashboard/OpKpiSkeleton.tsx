 ...
 *
 * Same footprint as OpKpi (min-h-[112px], rounded-[6px] border, p-[14px_16px])
...
export function OpKpiSkeleton() {
  return (
    <div
      className="flex flex-col rounded-[6px] border border-ln-op-line bg-ln-op-card p-[14px_16px] min-h-[112px]"
      aria-hidden="true"
    >
      {/* Label row */}
      <Skeleton className="op-skeleton-shimmer" w="55%" h="10px" radius="3px" />
      {/* Value */}
      <Skeleton className="op-skeleton-shimmer mt-[10px]" w="45%" h="30px" radius="4px" />
